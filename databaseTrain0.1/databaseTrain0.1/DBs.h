...
public:
	...
	Table select(string databaseName, string tableName, vector<string> columnName, Where selectCondition);
	Table select(string databaseName, string tableName, vector<string> columnName);  //无 where 语句
